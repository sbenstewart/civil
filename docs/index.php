...
<body>
    <div class="Hero center-div" id="preload">
        <svg class="Buildings" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="svg2"
            ...
            <g id="Page-1" fill="none" fill-rule="evenodd">
                <g id="Artboard-13-Copy">
                    <g id="town-sketch">
                        <g id="background">
                            <path id="Rectangle-673-Copy-10" fill="#ffab00"
                                d="M746.64 136.84l55.76-33.5 6.77-58V99.9l38.47-22.56v484.43h-101V136.84z" />
                            <path id="Rectangle-673-Copy-12" fill="#ffab00"
                                d="M646.64 77.35h108.1v484.43h-108.1V77.35z" />
                            <path id="Rectangle-673-Copy-25" fill="#ffab00" d="M418 110.1h78.37v452.4H418V110.1z" />
                            <path id="Rectangle-673-Copy-11" fill="#ff9100"
                                d="M444 196.38l-87-51.25V562.5h87V196.38z" />
                            <path id="Rectangle-673-Copy-24" fill="#ff9100"
                                d="M556 171.2h12.54v-16.06H458v16.05h11v391.3h87V171.2z" />
                            <path id="Rectangle-673-Copy-9" fill="#ffab00"
                                d="M126.64 78.97l49.02-79.7 51.98 79.7v482.8h-101V78.97z" />
                            <path id="Rectangle-673-Copy-22" fill="#ffab00"
                                d="M206.64 203.54l49.02-59.13 51.98 59.17V561.8h-101V203.53z" />
                            <path id="Rectangle-673-Copy-7" fill="#ff9100" d="M275.64 168.43h108v393.35h-108V168.43z" />
                            <path id="Rectangle-673-Copy-23" fill="#ff9100"
                                d="M543.64 109.38l108-54.05v506.45h-108v-452.4z" />
                            <path id="Rectangle-673-Copy-26" fill="#ffab00"
                                d="M157.64 257.96h12.54V245.5H59.64v12.46h11v303.82h87V257.96z" />
                        </g>
                        <g id="building7">
                            <path id="Rectangle-371-Copy-31" fill="url(#linearGradient-1)"
                                d="M4.08 0h97.96v222.87H4.08z" transform="translate(689 339)" />
                            ...
                            <g id="windows7">
                                <g id="Rectangle-372-Copy-73-+-Rectangle-372-Copy-75-+-Rectangle-372-Copy-76">
                                    ...
                                    <path id="Rectangle-372-Copy-76" fill="#f06f2a"
                                        d="M751.04 532.1h3.27v6.17h-3.23z" />
                                </g>
                        ...
                        <g id="building5">
                            ...
                            <path id="Rectangle-484-Copy-14" fill="url(#linearGradient3339)"
                                d="M17.5 174h114v13.5h-114z" transform="translate(538 242)" />
                        </g>
                        <g id="building6">
                            ...
                            <g id="windows6">
                                ...
                                <g id="g133">
                                    <path id="rect135" fill="#000" fill-opacity=".05"
                                        d="M813.9 446.68H863v34.9h-49.1z" />
                                ...
                                <g id="g143">
                                    <path id="rect145" fill="#000" fill-opacity=".05"
                                        d="M813.9 386.68H863v34.9h-49.1z" />
                                ...
                                <g id="g153">
                                    <path id="rect155" fill="#000" fill-opacity=".05"
                                        d="M813.9 326.68H863v34.9h-49.1z" />
                        ...
                        <g id="building3">
                            ...
                            <g id="windows3">
                                ...
                                <g id="Rectangle-372-Copy-46-+-Rectangle-372-Copy-48-+-Rectangle-372-Copy-98">
                                    <g id="g178">
                                        <path id="rect180" fill="#000" fill-opacity=".05"
                                            d="M286.5 333H392v26.5H286.5z" />
                        ...
                        <g id="building4">
                            ...
                            <path id="Rectangle-484-Copy-3" fill="#55A6D6" fill-opacity=".15" stroke="#FFF"
                                stroke-width="4" d="M377 199h177v-20H377z" />
                        ...
                        <g id="building2">
                            ...
                            <g id="windows2">
                                ...
                                <g id="g259">
                                    <path id="rect261" fill="#000" fill-opacity=".05"
                                        d="M129.9 443.68H179v34.9h-49.1z" />
                                    <path id="rect263" fill="#000" fill-opacity=".05"
                                        d="M189.9 443.68H239v34.9h-49.1z" />
                                ...
                                <g id="g288">
                                    <path id="rect290" fill="#000" fill-opacity=".05"
                                        d="M129.9 323.68H179v34.9h-49.1z" />
                                    <path id="rect292" fill="#000" fill-opacity=".05"
                                        d="M189.9 323.68H239v34.9h-49.1z" />
...
<header class="site-header">
    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" data-date="2020/03/05">
                ...
                <div class="featured-events-wrap flex flex-wrap justify-content-between">
                    <div class="event-content-wrap positioning-event-1">
                        <a href="ambassador.php">
                            ...
                            <header class="entry-header">
                                <h3 class="entry-title">Ambassador</h3>

                                <div class="posted-date">Get your referral code now!</div>
                            </header>
                        </a>
                    </div>
                    ...
                    <div class="event-content-wrap positioning-event-2">
                        <a href="accomodation.php">
                            ...
                            <header class="entry-header">
                                <h3 class="entry-title">Accomodation</h3>

                                <div class="posted-date">Limited capacity only</div>
                            </header>
                        </a>
                    </div>
                    ...
                    <div class="event-content-wrap positioning-event-8">
                        <a href="#lectures">
                            ...
                            <header class="entry-header">
                                <h3 class="entry-title">Guest Lectures</h3>

                                <div class="posted-date">Do attend them</div>
                            </header>
                        </a>
                    </div>
...
<div class="homepage-next-events" id="workshops">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="next-events-section-header">
                <h2 class="entry-title">Workshops</h2>
                <p>We as the Society of Civil Engineers have taken the effort to bring the best workshops to the college.</p>
            </div>
        </div>
...
<div class="homepage-regional-events" id="events">
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="swiper-container homepage-regional-events-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="entry-header">
                                <h2 class="entry-title">Reveal<br>The Civil</h2>
                            </div><!--- .entry-header -->
                ...
                <div class="swiper-container homepage-regional-events-slider-false">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <figure>
                        ...
                        <div class="swiper-slide">
                            <figure>
                                <img src="images/onlinememecontest.png" alt="">

                                <a class="event-overlay-link flex justify-content-center align-items-center" href="OnlineMemeContest.php">+</a>
                            </figure><!-- .hero-image -->

                            <div class="entry-header">
                                <h2 class="entry-title">Meme Contest</h2>
                            </div><!--- .entry-header -->
                        ...
                        <div class="swiper-slide">
                            <figure>
                                <img src="images/onlinephotographycontest.png" alt="">

                                <a class="event-overlay-link flex justify-content-center align-items-center" href="OnlinePhotographyContest.php">+</a>
                            </figure><!-- .hero-image -->

                            <div class="entry-header">
                                <h2 class="entry-title">Photography Contest</h2>
                            </div><!--- .entry-header -->
                ...
                <header class="regional-events-heading entry-header flex flex-wrap justify-content-between align-items-center" id="lectures">
                    <h2 class="entry-title">Guest Lectures</h2>
