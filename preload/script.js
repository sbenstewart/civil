...
=======
  var buildingAnimationMaxTime = 600;
  var buildingAnimationMinTime = 500;
>>>>>>> 296f510de9212d698dda93b75c2d39fe5ea42e8d
  ...
  function showBuildings(building, index) {
    TweenLite.to(
      ...
      getRandomAnimationTime(
        buildingAnimationMinTime,
        buildingAnimationMaxTime
      ),
      {
  ...
  function animateWindow(buildingWindow, index, windowGroup) {
    TweenLite.to($(buildingWindow), windowAnimationTime, {
      scaleX: 1,
      scaleY: 1,
  ...
  function showBackground() {
    TweenLite.to(background, backgroundAnimationTime, {
  ...
  function shuffle(array) {
    shuffledArray = array;
    for (
      var j, x, i = shuffledArray.length;
      i;
