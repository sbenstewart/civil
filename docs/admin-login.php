    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="get-in-touch">
                ...
                <div class="entry-content">
                    <p>Use the input section below to enter your emailid and password. Incase you have forgotten your password, enter your mailid and click on the 'Forgot Password' button down below.</p>
                </div>
                ...
                <div class="contact-form">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <input type="email" placeholder="Admin email" id="mail">
                        </div><!-- col-6 -->
                        ...
                        <div class="col-12 submit flex justify-content-center">
                            <input type="button" onclick="loginAdmin()" name="" value="Login" class="btn">
                        </div>
