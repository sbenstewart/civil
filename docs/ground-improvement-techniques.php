            ...
            <div class="container">
                ...
                <div class="row elements-wrap">
                    <div class="col-12 accordion-and-tabs-wrap">
                        <div class="entry-header">
                            <h2 class="entry-title">Ground Improvement Techniques</h2>
                        </div><!-- entry-header -->
                                  ...
                                  <div class="tabs">
                                      ...
                                      <div class="tabs-container">
                                          ...
                                          <div id="tab_about" class="tab-content">
                                            ...
                                            <p><b><strong>Avail the special discount of INR 200 on the tickets from 4 P.M. till midnight. Offer valid till slots last.</strong></b></p>
                                                  <?php
                                                  // Start the session
