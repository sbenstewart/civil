                                          ...
                                          <div id="tab_details" class="tab-content">
                                              ...
                                              <p>Innovative projects related to Civil Engineering.</p>
                                                ...
                                                <ol>
                                                  ...
                                                  <li>The softcopy of the abstract should be submitted to projectdisplay.c19@gmail.com on or before March 3,2019.You will receive a acknowledgement mail, if you are selected.</li>
                                                  <li>The presentation time per team is 20 minutes.</li>
                                                  <li>Any number of participants are allowed per team.</li>
                                                  <li>The fee is Rs.100 which must be paid onspot for each member whose team has been selected and recieve the acknowledgement email.</li>
                                                </ol>
