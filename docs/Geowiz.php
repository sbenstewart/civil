                ...
                <div class="row">
                    <div class="col-12">
                        <header class="entry-header">
                            <h1 class="entry-title">Geowiz</h1>
                        </header>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tabs-container">
                        <div id="tab_details" class="tab-content">
                            ...
                            <ol>
                                ...
                                <li>FINALS:
                                    <ul>
                                        <li>The participants will be asked to design a Flexible pavement for the given problem statement as per the IRC standards.</li>
                                    </ul>
                                </li>
                            </ol>
